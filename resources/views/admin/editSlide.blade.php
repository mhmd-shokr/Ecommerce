...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.updateSlide', $slide->id) }}"
                    ...
                    <fieldset>
                        ...
                        <div id="preview" style="margin-top:10px;">
                            <img id="previewImg" src="{{ $slide->image ? asset('storage/' . $slide->image) : '' }}"
                                alt="Preview"
                                style="max-width: 200px; {{ $slide->image ? 'display:block;' : 'display:none;' }} border:1px solid #ccc; padding:5px; border-radius:8px;">
                        </div>
                    </fieldset>
                    @error('image')
                        <small class="text-danger">{{ $message }}</small>
